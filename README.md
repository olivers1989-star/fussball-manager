...
- **Aufstellung mit freiem Positionieren**: Spieler irgendwo aufs 2D-Spielfeld ziehen – er spielt exakt dort. Das Feld ist in **Zonen** geteilt (TW · LV/IV/RV · DM/ZM/OM mit LM/RM außen · LA/MS/RA), die Zone bestimmt die gespielte Position; auch extreme Ausrichtungen (5 Stürmer!) sind möglich, die Ausrichtungs-Anzeige (z. B. „5-4-1") rechnet live mit. 7 Formations-Presets als Startpunkt, daneben die **Ersatzbank (max. 7 Plätze)**, rechts die detaillierte Kaderliste mit **Flaggen**, Talent, Marktwert, Ø-Note und Eigenschaften. **Slot-basiert mit Spielwirkung**: Jeder Spieler wird im Spiel auf seiner Zone bewertet – plus Vertrautheits-Abzug (−5 % gruppenintern, −25 % gruppenfremd, Feldspieler im Tor −50 %)
