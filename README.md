...
- **Aufstellung als 2D-Spielfeld**: 7 Formationen mit echten Positions-Slots auf dem Rasen, Spieler per Drag & Drop (oder Klick-Klick) aufstellen und tauschen, „Beste Elf"-Automatik. **Slot-basiert mit Spielwirkung**: Jeder Spieler wird im Spiel auf seinem Slot bewertet – ein Stürmer im Abwehr-Slot verteidigt mit seinen schwachen Defensiv-Attributen plus Vertrautheits-Abzug (−5 % gruppenintern, −25 % gruppenfremd, Feldspieler im Tor −50 %). Positionsfremde werden auf dem Feld markiert, die Elf-Stärke „auf Position" wird live angezeigt
