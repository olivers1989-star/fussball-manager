...
- **Aufstellung als 2D-Spielfeld**: 7 Formationen mit echten Positions-Slots auf dem Rasen – Spieler einfach irgendwo aufs Feld ziehen, die Position wird automatisch erkannt (nächster Slot). Rechts die detaillierte Kaderliste (Alter, Nationalität, Eigenschaften, Form, Frische), oben rechts auf dem Feld die **Ersatzbank (max. 7 Plätze)** – im Spiel darf nur von der nominierten Bank gewechselt werden. **Slot-basiert mit Spielwirkung**: Jeder Spieler wird im Spiel auf seinem Slot bewertet – ein Stürmer im Abwehr-Slot verteidigt mit seinen schwachen Defensiv-Attributen plus Vertrautheits-Abzug (−5 % gruppenintern, −25 % gruppenfremd, Feldspieler im Tor −50 %). Positionsfremde werden auf dem Feld markiert, die Elf-Stärke „auf Position" wird live angezeigt
